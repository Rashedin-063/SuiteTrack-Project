...
const Page = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gray-100">
                    ...
                    >
                        <motion.div variants={itemVariants} className="space-y-4">
                            ...
                            <p className="text-gray-600">
                                We are dedicated to minimizing our environmental impact and promoting sustainable tourism. Our initiatives
                                include:
                            </p>
                            <motion.ul variants={containerVariants} className="list-disc list-inside text-gray-600 space-y-2">
                                <motion.li variants={itemVariants}>Solar power generation</motion.li>
                                <motion.li variants={itemVariants}>Water conservation programs</motion.li>
                                <motion.li variants={itemVariants}>Waste reduction and recycling</motion.li>
                                <motion.li variants={itemVariants}>Use of eco-friendly cleaning products</motion.li>
                                <motion.li variants={itemVariants}>Support for local conservation projects</motion.li>
                            </motion.ul>
                            <motion.button
            ...
            <div className='my-12'>
                <h2 className='text-4xl text-center my-2 text-black'>Hotel Facilities</h2>
    ...
    <h2 className="text-black text-2xl sm:text-3xl text-center">Professionals</h2>
    ...
    <div className="container mx-auto px-4 pt-8">
        <Marquee>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-gray-800 text-center mb-12 animate-fade-in-down">What Our Guests Say</h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            { name: 'John D.', location: 'New York, USA', comment: 'Exceptional service and stunning views. Will definitely return!' },
                            { name: 'Maria S.', location: 'London, UK', comment: 'The spa treatments were out of this world. So relaxing!' },
                            { name: 'Hiroshi T.', location: 'Tokyo, Japan', comment: 'Impeccable attention to detail. A truly luxurious experience.' },
                        ].map((review, index) => (
                            <div key={index} className="bg-white rounded-lg shadow-md p-6">
                                ...
                                <div className="flex mt-4">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        <IoStar key={star} className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                                    ))}
                                </div>
                            </div>
                        ))}
