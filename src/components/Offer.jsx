...
const Offer = () => {
  ...
  //         <div
  //           key={offerData.id}
  //           className='flex justify-center items-center border-x-8 border-white'
  //         >
  //           <div
  //             className='bg-[#00000066] bg-blend-multiply text-[#bd9966] text-center border-r-4 p-4'
  //             style={{
  //               backgroundImage:
  //                 'url(https://i.postimg.cc/9X9JZgWH/interior-design-neoclassical-style-with-furnishings-decor-1.jpg)',
  //             }}
  //           >
  //             <div className='border-2 border-[#bd9966] py-4 px-10'>
  //               <h6 className='text-white text-5xl font-bold uppercase'>
  //                 {offerData.offer}% <br />
  //                 off
  //               </h6>
  //               <h6 className='border-2 border-[#bd9966] p-2 m-4 text-xl'>
  //                 {offerData.category} Room
  //               </h6>
  //               <ul>
  //                 {offerData.speciality?.map((facilities, index) => (
  ...
  //             width={500}
  //             height={500}
  //             alt={offerData.category}
  //             src={offerData.image}
  //             className='w-[550px] h-[392px]'
  //           />
  //         </div>
  //       ))}
  //     </Marquee>
