    ...
    <div>
      <div className='mt-2 flex flex-col md:flex-row justify-between'>
        <button
          ...
          hover:bg-green-700 text-white px-8 py-2 rounded-md mb-2 md:mb-0 justify-center disabled:bg-gray-600 disabled:cursor-not-allowed'
        >
          <FaGoogle size={21} />
        ...
        <button
          ...
          className='cursor-pointer text-lg flex gap-3 items-center bg-deep-ocean 
          hover:bg-green-700 text-white px-8 py-2 rounded-md justify-center disabled:bg-gray-600 disabled:cursor-not-allowed'
        >
          <FaGithub size={23} />
