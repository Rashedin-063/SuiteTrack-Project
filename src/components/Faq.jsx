	...
	const content = [
		{
			...
			content: (
				<div className="h-full w-full flex items-center justify-center text-white">
					<Image width={500} height={500} alt='photo' src={payment} />
				</div>
			),
		},
		{
			...
			content: (
				<div className="h-full w-full flex items-center justify-center text-white">
					<Image width={500} height={500} alt='photo' src={booking} />
				</div>
			),
		},
		{
			...
			content: (
				<div className="h-full w-full flex items-center justify-center text-white">
					<Image width={500} height={500} alt='photo' src={amenities} />
				</div>
			),
		},
		{
			...
			content: (
				<div className="h-full w-full flex items-center justify-center text-white">
					<Image width={500} height={500} alt='photo' src={transport} />
				</div>
			),
		},
		{
			...
			content: (
				<div className="h-full w-full flex items-center justify-center text-white">
					<Image width={500} height={500} alt='photo' src={checkin} />
				</div>
			),
		},
	];
