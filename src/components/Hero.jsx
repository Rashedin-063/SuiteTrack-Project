...
const Hero = () => {
  return (
    <div>
      <div className="bg-no-repeat bg-cover bg-center bg-[#00000033] bg-blend-multiply rounded-3xl px-32 pt-36" style={{ backgroundImage: "url(https://i.postimg.cc/9X9JZgWH/interior-design-neoclassical-style-with-furnishings-decor-1.jpg)" }}>
