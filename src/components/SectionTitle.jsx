...
const SectionTitle = ({ heading, description }) => {
    return (
        <div>
            ...
            <h6 className="text-center text-[#9f6411] text-4xl font-semibold uppercase">{heading}</h6>
            <p className="text-center text-[#9f6411cc] max-w-3xl mx-auto mt-2">{description}</p>
        </div>
    );
};
